...
# 要读取人脸图像文件的路径
path_images_from_camera= "./src/start_detect/Resources/faceS/"
path_featureDB= "./src/start_detect/Resources/featureDB/"
path_featureMean="./src/start_detect/Resources/featureMean/"
resources_path = os.path.abspath(os.path.join("./src/start_detect", "Resources"))
predictor_path     = os.path.join(resources_path, "shape_predictor_68_face_landmarks.dat")
...
faces = sorted(os.listdir(path_images_from_camera))
i=0
for person in faces:
    i+=1
...
features = sorted(os.listdir(path_featureDB))
i=0
